...
eval_cases:
- id: security-auditor-approach
  prompt: How should I approach security auditor for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on security auditor
  tags:
  - security
- id: security-auditor-best-practices
  prompt: What are the key best practices and pitfalls for security auditor?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for security auditor
  tags:
  - security
  - best-practices
- id: security-auditor-antipatterns
  prompt: What are the most common mistakes to avoid with security auditor?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
