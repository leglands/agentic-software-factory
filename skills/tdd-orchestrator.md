...
eval_cases:
- id: tdd-orchestrator-approach
  prompt: How should I approach tdd orchestrator for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on tdd orchestrator
  tags:
  - tdd
- id: tdd-orchestrator-best-practices
  prompt: What are the key best practices and pitfalls for tdd orchestrator?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for tdd orchestrator
  tags:
  - tdd
  - best-practices
- id: tdd-orchestrator-antipatterns
  prompt: What are the most common mistakes to avoid with tdd orchestrator?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
