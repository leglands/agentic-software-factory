...
metadata:
  ...
  triggers:
  - claude needs to create or
eval_cases:
- id: react-flow-architect-approach
  prompt: How should I approach react flow architect for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on react flow architect
  tags:
  - react
- id: react-flow-architect-best-practices
  prompt: What are the key best practices and pitfalls for react flow architect?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for react flow architect
  tags:
  - react
  - best-practices
- id: react-flow-architect-antipatterns
  prompt: What are the most common mistakes to avoid with react flow architect?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
