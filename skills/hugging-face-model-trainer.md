...
description: This skill should be used when users want to train or fine-tune language
  ...
  Covers SFT, DPO, GRPO and reward ...
metadata:
  category: development
  source: 'antigravity-awesome-skills (MIT) — source: community'
  triggers:
  - when working on hugging face model trainer
eval_cases:
- id: hugging-face-model-trainer-approach
  prompt: How should I approach hugging face model trainer for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on hugging face model trainer
  tags:
  - hugging
- id: hugging-face-model-trainer-best-practices
  prompt: What are the key best practices and pitfalls for hugging face model trainer?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for hugging face model trainer
  tags:
  - hugging
  - best-practices
- id: hugging-face-model-trainer-antipatterns
  prompt: What are the most common mistakes to avoid with hugging face model trainer?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
