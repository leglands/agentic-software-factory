...
metadata:
  ...
  triggers:
  - when working on security scanning security sast
eval_cases:
- id: security-scanning-security-sast-approach
  prompt: How should I approach security scanning security sast for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on security scanning security sast
  tags:
  - security
- id: security-scanning-security-sast-best-practices
  ...
  - no_placeholder
  expectations:
  - Lists concrete best practices for security scanning security sast
  tags:
  - security
  - best-practices
- id: security-scanning-security-sast-antipatterns
