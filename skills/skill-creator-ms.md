...
metadata:
  ...
  triggers:
  - creating new skills or updating existing skills
eval_cases:
- id: skill-creator-ms-approach
  prompt: How should I approach skill creator ms for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on skill creator ms
  tags:
  - skill
- id: skill-creator-ms-best-practices
  prompt: What are the key best practices and pitfalls for skill creator ms?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for skill creator ms
  tags:
  - skill
  - best-practices
- id: skill-creator-ms-antipatterns
  prompt: What are the most common mistakes to avoid with skill creator ms?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
