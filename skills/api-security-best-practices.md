...
eval_cases:
- id: api-security-best-practices-approach
  prompt: How should I approach api security best practices for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on api security best practices
  tags:
  - api
- id: api-security-best-practices-best-practices
  prompt: What are the key best practices and pitfalls for api security best practices?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for api security best practices
  tags:
  - api
  - best-practices
- id: api-security-best-practices-antipatterns
  prompt: What are the most common mistakes to avoid with api security best practices?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
