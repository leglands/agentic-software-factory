...
metadata:
  ...
  triggers:
  - the user wants live chat, customer support chat, real-time messaging, or in
  - build customer support chat functionality
  - create real-time messaging between users and admins
eval_cases:
- id: chat-widget-approach
  prompt: How should I approach chat widget for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on chat widget
  tags:
  - chat
- id: chat-widget-best-practices
  prompt: What are the key best practices and pitfalls for chat widget?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for chat widget
  tags:
  - chat
  - best-practices
- id: chat-widget-antipatterns
  prompt: What are the most common mistakes to avoid with chat widget?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
