...
eval_cases:
- id: code-review-checklist-approach
  prompt: How should I approach code review checklist for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on code review checklist
  tags:
  - code
- id: code-review-checklist-best-practices
  prompt: What are the key best practices and pitfalls for code review checklist?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for code review checklist
  tags:
  - code
  - best-practices
- id: code-review-checklist-antipatterns
  prompt: What are the most common mistakes to avoid with code review checklist?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
