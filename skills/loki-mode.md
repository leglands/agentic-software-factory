...
metadata:
  ...
  triggers:
  - when working on loki mode
eval_cases:
- id: loki-mode-approach
  prompt: How should I approach loki mode for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on loki mode
  tags:
  - loki
- id: loki-mode-best-practices
  prompt: What are the key best practices and pitfalls for loki mode?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for loki mode
  tags:
  - loki
  - best-practices
- id: loki-mode-antipatterns
  prompt: What are the most common mistakes to avoid with loki mode?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
