...
eval_cases:
- id: kubernetes-architect-approach
  prompt: How should I approach kubernetes architect for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on kubernetes architect
  tags:
  - kubernetes
- id: kubernetes-architect-best-practices
  prompt: What are the key best practices and pitfalls for kubernetes architect?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for kubernetes architect
  tags:
  - kubernetes
  - best-practices
- id: kubernetes-architect-antipatterns
  prompt: What are the most common mistakes to avoid with kubernetes architect?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
