...
eval_cases:
- id: angular-approach
  prompt: How should I approach angular for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on angular
  tags:
  - angular
- id: angular-best-practices
  prompt: What are the key best practices and pitfalls for angular?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for angular
  tags:
  - angular
  - best-practices
- id: angular-antipatterns
  prompt: What are the most common mistakes to avoid with angular?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
