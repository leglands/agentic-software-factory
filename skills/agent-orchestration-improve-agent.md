...
metadata:
  ...
  triggers:
  - when working on agent orchestration improve agent
eval_cases:
- id: agent-orchestration-improve-agent-approach
  prompt: How should I approach agent orchestration improve agent for a production
    system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on agent orchestration improve agent
  tags:
  - agent
- id: agent-orchestration-improve-agent-best-practices
  prompt: What are the key best practices and pitfalls for agent orchestration improve
    agent?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for agent orchestration improve agent
  tags:
  - agent
  - best-practices
- id: agent-orchestration-improve-agent-antipatterns
  prompt: What are the most common mistakes to avoid with agent orchestration improve
    agent?
  should_trigger: true
  checks:
  - length_min:80
