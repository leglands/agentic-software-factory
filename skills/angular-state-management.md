...
metadata:
  ...
  triggers:
  - setting up global state, managing component stores, choosing between state solut
  - setting up global state management in angular
eval_cases:
- id: angular-state-management-approach
  prompt: How should I approach angular state management for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on angular state management
  tags:
  - angular
- id: angular-state-management-best-practices
  prompt: What are the key best practices and pitfalls for angular state management?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for angular state management
  tags:
  - angular
  - best-practices
- id: angular-state-management-antipatterns
  prompt: What are the most common mistakes to avoid with angular state management?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
