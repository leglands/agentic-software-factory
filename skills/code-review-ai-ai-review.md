...
metadata:
  ...
  - needing guidance, best practices, or checklists for ai-powered code review speci
  - the task is unrelated to ai-powered code review specialist
eval_cases:
- id: code-review-ai-ai-review-approach
  prompt: How should I approach code review ai ai review for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on code review ai ai review
  tags:
  - code
- id: code-review-ai-ai-review-best-practices
  prompt: What are the key best practices and pitfalls for code review ai ai review?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for code review ai ai review
  tags:
  - code
  - best-practices
- id: code-review-ai-ai-review-antipatterns
  prompt: What are the most common mistakes to avoid with code review ai ai review?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
