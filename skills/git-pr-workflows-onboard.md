...
eval_cases:
- id: git-pr-workflows-onboard-approach
  prompt: How should I approach git pr workflows onboard for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on git pr workflows onboard
  tags:
  - git
- id: git-pr-workflows-onboard-best-practices
  prompt: What are the key best practices and pitfalls for git pr workflows onboard?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for git pr workflows onboard
  tags:
  - git
  - best-practices
- id: git-pr-workflows-onboard-antipatterns
  prompt: What are the most common mistakes to avoid with git pr workflows onboard?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
