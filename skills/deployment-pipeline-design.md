...
metadata:
  ...
  triggers:
  - architecting deployment workflows, setting up continuous delivery, or implementi
  - the task is unrelated to deployment pipeline design
eval_cases:
- id: deployment-pipeline-design-approach
  prompt: How should I approach deployment pipeline design for a production system?
  should_trigger: true
  checks:
  - length_min:150
  - no_placeholder
  expectations:
  - Provides concrete guidance on deployment pipeline design
  tags:
  - deployment
- id: deployment-pipeline-design-best-practices
  prompt: What are the key best practices and pitfalls for deployment pipeline design?
  should_trigger: true
  checks:
  - length_min:100
  - no_placeholder
  expectations:
  - Lists concrete best practices for deployment pipeline design
  tags:
  - deployment
  - best-practices
- id: deployment-pipeline-design-antipatterns
  prompt: What are the most common mistakes to avoid with deployment pipeline design?
  should_trigger: true
  checks:
  - length_min:80
  - no_placeholder
